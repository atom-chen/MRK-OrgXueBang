...
#
# RF_CHANNELS=(101003 102001 102002 102003 102004 102005 102006 102007 102008 102009 102010 102011 102012 102013)
RF_CHANNELS=(101003 102001 102002 102003 102004 102005 102006 102007 102008 102011)
...
build_old() {
	echo $RF_DIR_OLD
	echo $CURRENT_DIR
    cocos compile -s $RF_DIR_OLD  -p android --android-studio -j 4 --ap android-22 --app-abi armeabi -m release -o   $CURRENT_DIR/RF_out_apk/old_apk
}

build_apk() {
    cocos compile -s $CURRENT_DIR/RF_build/ReadingMate -p android --android-studio -j 4 --ap android-22 --app-abi armeabi -m release   -o   $CURRENT_DIR/RF_out_apk/$1
