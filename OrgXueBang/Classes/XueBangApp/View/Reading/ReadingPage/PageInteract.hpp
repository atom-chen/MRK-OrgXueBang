...
#ifndef PageInteract_hpp
#define PageInteract_hpp

#include "PageBase.hpp"
#include "BookStruct.hpp"
#include "stdafx.h"
#include "ConstantEnum.hpp"
#include "MyText.hpp"

class PageInteract : public PageBase
{
    enum ButtonType
    {
        eBtnBack = 0,   //顶部-返回
...
public:
    PageInteract();
    virtual ~PageInteract();
    
    static PageInteract* create();
    static PageInteract* create(Widget* pageUI);
