...

{
    ...
    NSString * const KEY_USERNAME_PASSWORD = @"com.xuebang.tingshuo.usernamepassword";
    
    NSString * const KEY_PASSWORD = @"com.xuebang.tingshuo.password";
    ...
    NSMutableDictionary *readUserPwd = (NSMutableDictionary *)[baseIdfv load:KEY_USERNAME_PASSWORD];
    ...
    if (!readUserPwd) {
        ...
        [baseIdfv save:KEY_USERNAME_PASSWORD data:usernamepasswordKVPairs];
